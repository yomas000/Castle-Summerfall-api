 ...
 * It loads the options in from json files contained in the file specified by pathPath
 */
public class Generator {

    //This stores the location of the file which stores the location of all of the other files, which allows for easily loading new files.
    //Important for easily adding mod support and just easily modifying the file structure.
    private static String pathPath = "lib/data/config/paths.json";//TODO: add .. to this for the binaries @yomas000

    //stores the boss being generated by the generator when it's generating a floor.
